<?php
namespace Ehb\Core\Metadata\Integration\Chamilo\Core\Admin;
...
class Manager implements ActionsSupportInterface
{
    ...
    public static function get_actions()
    {
        ...
        $redirect = new Redirect(
            array(
                Application :: PARAM_CONTEXT => \Ehb\Core\Metadata\Manager :: context(),
                Application :: PARAM_ACTION => \Ehb\Core\Metadata\Manager :: ACTION_SCHEMA));
