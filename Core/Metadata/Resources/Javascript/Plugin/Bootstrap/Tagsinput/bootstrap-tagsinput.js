(function($) {
    ...
    TagsInput.prototype = {
        ...
        /**
         * Removes the given item. Pass true to dontPushVal to prevent updating
         * the elements val()
         */
        ...
        /**
         * Refreshes the tags so they match the text/value of their
         * corresponding item.
         */
        refresh : function() {
            var self = this;
        ...
        /**
         * Assembly value by retrieving the value of each item, and set it on
         * the element.
         */
        pushVal : function() {
            ...
            // FREE INPUT CHANGE START
            // if text and objects are mixed, put the text items in the
            // alternative input element
            if (self.$freeElement) {
        ...
        build : function(options) {
            ...
            self.$container.on('keypress', 'input', $.proxy(function(event) {
                ...
                // if we are in mixed mode (both objectItems and freeInput),
                // create a "freeText" item
                if (self.objectItems) {
                var obj = {
                    _freeText : true
                }
         ...
         * is normally the $container, but typeahead.js moves the $input
         * element.
         */
     ...
     * option value. This function makes sure that the option with the given key
     * in the given options is wrapped in a function
     */
    ...
    /**
     * Returns boolean indicates whether user has pressed an expected key
     * combination.
     * 
     * @param object
     ...
     * @param object
     *            lookupList: expected key combinations, as in: [13, {which:
     *            188, shiftKey: true}]
     */
