...
use Ehb\Core\Metadata\Vocabulary\Table\Select\SelectTable;
 ...
 */
class SelectComponent extends \Ehb\Core\Metadata\Vocabulary\Ajax\Manager implements TableSupport
{
    ...
    /**
     *
     * @var \Ehb\Core\Metadata\Element\Storage\DataClass\Element
     */
    private $element;
    ...
    public function run()
    {
        $elementId = $this->getPostDataValue(\Ehb\Core\Metadata\Element\Manager :: PARAM_ELEMENT_ID);
    ...
    public function getContent()
    {
        ...
        if (count($vocabularyIds) > 0)
        {
            ...
            $html[] = 'var elementIdentifier = ' . json_encode(
                $this->getRequest()->query->get(\Ehb\Core\Metadata\Vocabulary\Ajax\Manager :: PARAM_ELEMENT_IDENTIFIER)) .
                 ';';
            $html[] = '</script>';
    ...
    public function getSelectedElementId()
    {
        ...
        {
            $this->elementId = $this->getPostDataValue(\Ehb\Core\Metadata\Element\Manager :: PARAM_ELEMENT_ID);
        }
    ...
    /**
     *
     * @return \Ehb\Core\Metadata\Element\Storage\DataClass\Element
     */
    public function getSelectedElement()
    {
        if (! isset($this->element))
        {
            $this->element = DataManager :: retrieve_by_id(
                \Ehb\Core\Metadata\Element\Storage\DataClass\Element :: class_name(),
    ...
    {
        return (array) $this->getRequest()->query->get(\Ehb\Core\Metadata\Vocabulary\Manager :: PARAM_VOCABULARY_ID);
    }
    ...
    {
        return array(\Ehb\Core\Metadata\Element\Manager :: PARAM_ELEMENT_ID);
    }

    public function get_additional_parameters()
    {
        return array(
            \Ehb\Core\Metadata\Element\Manager :: PARAM_ELEMENT_ID,
            \Ehb\Core\Metadata\Vocabulary\Ajax\Manager :: PARAM_ELEMENT_IDENTIFIER);
    }
}