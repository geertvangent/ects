...
class Autoloader
{
     ...
     */
     private static $map = array(
         ...
         'RightsLocation' => '/lib/data_class/rights_location.class.php',
         'RightsLocationEntityRight' => '/lib/data_class/rights_location_entity_right.class.php',
         'RightsLocationEntityRightGroup' => '/lib/data_class/rights_location_entity_right_group.class.php',
