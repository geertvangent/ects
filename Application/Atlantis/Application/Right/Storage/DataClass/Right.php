<?php
namespace Ehb\Application\Atlantis\Application\Right\Storage\DataClass;
...
class Right extends DataClass
{
    ...
    public function get_application()
    {
        ...
        {
            $this->application = \Ehb\Application\Atlantis\Application\Storage\DataManager :: retrieve_by_id(
