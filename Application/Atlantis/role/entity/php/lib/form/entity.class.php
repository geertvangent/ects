...
class EntityForm extends FormValidator
{
    ...
    public function build()
    {
        ...
        $types->add_element_type(
                new AdvancedElementFinderElementType('roles', Translation :: get('Roles'), 'application\atlantis\role', 
                        'roles_feed', array()));
        ...
        $types->add_element_type(
                new AdvancedElementFinderElementType('contexts', Translation :: get('Contexts'), 
                        'application\atlantis\context', 'contexts_feed', array()));
        
        $this->addElement('advanced_element_finder', self :: PROPERTY_CONTEXT, Translation :: get('Contexts'), $types);
        
        // start date
        $this->addElement('text', self :: PROPERTY_START_DATE, Translation :: get('StartDate'), 
        ...
        // end date
        $this->addElement('text', self :: PROPERTY_END_DATE, Translation :: get('EndDate'), 
