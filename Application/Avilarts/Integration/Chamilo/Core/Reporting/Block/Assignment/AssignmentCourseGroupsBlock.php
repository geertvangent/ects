...
class AssignmentCourseGroupsBlock extends AssignmentSubmittersBlock
{
    ...
    public function get_submitters()
    {
        ...
        return \Ehb\Application\Avilarts\Storage\DataManager :: retrieve_publication_target_course_groups(
    ...
    {
        // Course groups
        $submissions_resultset = \Ehb\Application\Avilarts\Tool\Implementation\Assignment\Storage\DataManager :: retrieve_submissions_by_submitter_type(
            $this->get_publication_id(), 
            AssignmentSubmission :: SUBMITTER_TYPE_COURSE_GROUP);
        
        $this->get_array_from_resultset($submissions_resultset, $this->submissions);
        
        $feedbacks_resultset = \Ehb\Application\Avilarts\Tool\Implementation\Assignment\Storage\DataManager :: retrieve_submitter_feedbacks(
            $this->get_publication_id(), 
            AssignmentSubmission :: SUBMITTER_TYPE_COURSE_GROUP);
