...
abstract class ToolInstaller extends \Chamilo\Configuration\Package\Action\Installer
{
    ...
    protected function install_tool_for_existing_course_types()
    {
        ...
        while ($course_type = $course_types->next_result())
        {
            if (! $this->install_static_tool_setting_relations_for_object(
                $course_type,
                '\Ehb\Application\Avilarts\CourseType\Storage\DataClass\CourseTypeRelCourseSetting',
                '\Ehb\Application\Avilarts\CourseType\Storage\DataClass\CourseTypeRelCourseSettingValue',
                'set_course_type_id',
    ...
    protected function install_tool_for_existing_courses()
    {
        ...
        while ($course = $courses->next_result())
        {
            if (! $this->install_static_tool_setting_relations_for_object(
                $course,
                '\Ehb\Application\Avilarts\Course\Storage\DataClass\CourseRelCourseSetting',
                '\Ehb\Application\Avilarts\Course\Storage\DataClass\CourseRelCourseSettingValue',
                'set_course_id',
