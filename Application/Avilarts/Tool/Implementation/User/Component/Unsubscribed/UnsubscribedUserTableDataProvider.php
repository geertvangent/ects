...
class UnsubscribedUserTableDataProvider extends DataClassTableDataProvider
{
    ...
    {
        return \Ehb\Application\Avilarts\Course\Storage\DataManager :: retrieve_users_not_subscribed_to_course(
    ...
    {
        return \Ehb\Application\Avilarts\Course\Storage\DataManager :: count_users_not_subscribed_to_course(
            $this->get_component()->get_course_id(), 
            $condition);
    }
}
