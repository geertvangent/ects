...
class SubscribedUserBrowserTableDataProvider extends RecordTableDataProvider
{
    ...
    {
        return \Ehb\Application\Avilarts\Course\Storage\DataManager :: retrieve_users_directly_subscribed_to_course(
            $condition, 
            $offset, 
            $count, 
            $order_property);
    ...
    {
        return \Ehb\Application\Avilarts\Course\Storage\DataManager :: count_users_directly_subscribed_to_course(
            $condition);
    }
}
