...
use Ehb\Application\Avilarts\Form\CourseTypeUserCategoryRelCourseForm;
use Ehb\Application\Avilarts\Form\CourseUserCategoryForm;
use Ehb\Application\Avilarts\Manager;
use Ehb\Application\Avilarts\Renderer\CourseList\Type\CourseTypeCourseListRenderer;
...
class SorterComponent extends Manager
{
     ...
     */
    public function get_actionbar(CourseTypeCourseListRenderer $renderer)
    {
