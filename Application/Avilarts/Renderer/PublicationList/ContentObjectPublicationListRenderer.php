<?php
namespace Ehb\Application\Avilarts\Renderer\PublicationList;
...
abstract class ContentObjectPublicationListRenderer
{
    ...
    public function is_visible_for_target_users($publication)
    {
        return (! $publication[ContentObjectPublication :: PROPERTY_HIDDEN] &&
             ...
             $publication[ContentObjectPublication :: PROPERTY_TO_DATE] == 0) || ($publication[ContentObjectPublication :: PROPERTY_FROM_DATE] <=
