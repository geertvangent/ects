...
class Rights extends RightsUtil
{
    ...
    {
        return parent :: get_root(Manager :: context(), \Ehb\Application\Avilarts\Rights\Rights :: TREE_TYPE_COURSE, $tree_identifier);
    }

    public function get_courses_subtree_root_id($tree_identifier = 0)
    {
        return parent :: get_root_id(Manager :: context(), \Ehb\Application\Avilarts\Rights\Rights :: TREE_TYPE_COURSE, $tree_identifier);
    }
