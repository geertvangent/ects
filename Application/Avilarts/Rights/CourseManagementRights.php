 ...
 */
class CourseManagementRights extends \Ehb\Application\Avilarts\Rights\Rights
{
    /**
     * **************************************************************************************************************
     * Rights Definitions *
    ...
    public function is_allowed_for_platform_group($right_id, $group_id, $course_id)
    {
        ...
        if (! $this->rights[$entity_type][$group_id])
        {
            ...
            $location = CourseDataManager :: retrieve(Course :: class_name(), $course_id)->get_rights_location();
