...
class ContentObjectPublication extends DataClass implements DisplayOrderDataClassListenerSupport
{
    ...
    public function create($create_in_batch = false)
    {
        ...
        else
        {
            ...
            {
                $parent_id = \Ehb\Application\Avilarts\Rights\Rights :: get_instance()->get_courses_subtree_root_id(
                    $this->get_course_id());
    ...
    {
        return \Ehb\Application\Avilarts\Rights\Rights :: get_instance()->render_target_entities_as_string(
            $this->get_target_entities());
    }
