...
class Autoloader
{
    ...
    private static $map = array('Autoloader' => '/autoloader.class.php',
            ...
            'Choice' => '/lib/choice.class.php', 'ChoiceOption' => '/lib/choice_option.class.php',
            'Group' => '/lib/group.class.php', 'Language' => '/lib/language.class.php',
            'Major' => '/lib/major.class.php', 'MajorChoice' => '/lib/major_choice.class.php',
            'MajorChoiceOption' => '/lib/major_choice_option.class.php', 'Module' => '/lib/module.class.php',
            'Package' => '/lib/package.class.php', 'PackageCourse' => '/lib/package_course.class.php',
            'Parameters' => '/lib/parameters.class.php', 'Rights' => '/lib/rights.class.php',
            'SubTrajectory' => '/lib/sub_trajectory.class.php',
            'SubTrajectoryCourse' => '/lib/sub_trajectory_course.class.php', 'Trajectory' => '/lib/trajectory.class.php',
