...
class Autoloader
{
    ...
    private static $map = array('Autoloader' => '/autoloader.class.php', 
            ...
            'BamaflexAjaxUsersFeed' => '/ajax/users_feed.class.php', 'Course' => '/lib/course.class.php', 
            ...
            'Rights' => '/lib/rights.class.php', 'DataSource' => '/lib/data_manager/data_source.class.php', 
