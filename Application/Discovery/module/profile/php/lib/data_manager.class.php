...
class DataManager
{
    ...
    static function get_instance($discovery_module_instance)
    {
        ...
        {
            require_once Path :: namespace_to_full_path(Utilities :: get_namespace_from_classname($discovery_module_instance->get_type())) . 'php/data_manager/data_source.class.php';
            $class = Utilities :: get_namespace_from_classname($discovery_module_instance->get_type()) . '\\DataSource';
