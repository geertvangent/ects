...
class BamaflexAjaxPlatformGroupsFeed extends CommonAjaxGroupsFeed
{
    ...
    public function retrieve_groups()
    {
        ...
        $targets_entities = Rights :: get_instance()->get_module_targets_entities(
            $this->get_parameter(self :: PARAM_MODULE_INSTANCE_ID), 
            $this->get_parameter(self :: PARAM_PARAMETERS));
    ...
    public function get_group_element($group)
    {
        return new AdvancedElementFinderElement(
            RightsPlatformGroupEntity :: ENTITY_TYPE . '_' . $group->get_id(), 
            'type type_group', 
            $group->get_name(), 
            $group->get_code(), 
    ...
    {
        return new AdvancedElementFinderElement(
            RightsUserEntity :: ENTITY_TYPE . '_' . $user->get_id(), 
            'type type_user', 
            $user->get_fullname(), 
