...
class Autoloader
{
    ...
    private static $map = array('Autoloader' => '/autoloader.class.php', 
            ...
            'BamaflexAjaxUsersFeed' => '/ajax/users_feed.class.php', 'Module' => '/lib/module.class.php', 
            'Rights' => '/lib/rights.class.php', 'TeachingAssignment' => '/lib/teaching_assignment.class.php', 
