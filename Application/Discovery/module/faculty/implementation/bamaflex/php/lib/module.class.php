...
class Module extends \application\discovery\module\faculty\Module
{
    ...
    function get_faculties_table($year)
    {
        ...
        foreach ($faculties as $key => $faculty)
        {
            ...
            {
                $parameters = new \application\discovery\module\faculty_info\implementation\bamaflex\Parameters($faculty->get_id(), $faculty->get_source());
            ...
            if ($photo_module_instance)
            {
                ...
                $row[] = Theme :: get_image('logo/16', 'png', Translation :: get('TypeName', null, 'application\discovery\module\photo\implementation\bamaflex'), $url, ToolbarItem :: DISPLAY_ICON, false, 'application\discovery\module\photo\implementation\bamaflex');
