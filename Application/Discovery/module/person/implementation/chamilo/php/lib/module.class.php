...
class Module extends \application\discovery\module\person\Module implements NewObjectTableSupport
{
    ...
    function get_users_condition()
    {
        ...
        if (isset($query) && $query != '')
        {
            ...
            $search_properties[] = new ConditionProperty(User :: PROPERTY_FIRSTNAME);
            $search_properties[] = new ConditionProperty(User :: PROPERTY_LASTNAME);
            $search_properties[] = new ConditionProperty(User :: PROPERTY_USERNAME);
            $search_properties[] = new ConditionProperty(User :: PROPERTY_OFFICIAL_CODE);
            return $this->action_bar->get_conditions($search_properties);
        }
        else
        {
