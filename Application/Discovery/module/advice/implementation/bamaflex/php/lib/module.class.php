        ...
        if ($this->has_advices())
        {
            ...
            foreach ($enrollments as $enrollment)
            {
                if ($this->has_advices($enrollment))
                {
                    ...
                    $enrollment_namespace = Utilities :: get_namespace_from_classname(Enrollment :: CLASS_NAME);
                    ...
                    if ($enrollment->is_special_result())
                    {
                        ...
                        $tab_image = '<img src="' . $tab_image_path . '" alt="' . Translation :: get($enrollment->get_result_string(), null, $enrollment_namespace) . '" title="' . Translation :: get($enrollment->get_result_string(), null, $enrollment_namespace) . '" />';
                        $html[] = $tab_image;
                        LegendTable :: get_instance()->add_symbol($tab_image, Translation :: get($enrollment->get_result_string(), null, $enrollment_namespace), Translation :: get('ResultType'), null, $enrollment_namespace);
                    }
                    ...
                    $tab_image = '<img src="' . $tab_image_path . '" alt="' . Translation :: get($enrollment->get_contract_type_string(), null, $enrollment_namespace) . '" title="' . Translation :: get($enrollment->get_contract_type_string(), null, $enrollment_namespace) . '" />';
                    $html[] = $tab_image;
                    LegendTable :: get_instance()->add_symbol($tab_image, Translation :: get($enrollment->get_contract_type_string(), null, $enrollment_namespace), Translation :: get('ContractType'), null, $enrollment_namespace);
