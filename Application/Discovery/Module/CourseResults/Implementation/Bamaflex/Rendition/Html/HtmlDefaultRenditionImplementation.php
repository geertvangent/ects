<?php
namespace Chamilo\Application\Discovery\Module\CourseResults\Implementation\Bamaflex\Rendition\Html;
                ...
                if ($mark->get_status())
                {
                    if ($mark->is_abandoned())
                    {
                        $mark_status_image = '<img src="' .
                             Theme :: getInstance()->getImagePath('application\discovery\module\career\implementation\bamaflex') .
