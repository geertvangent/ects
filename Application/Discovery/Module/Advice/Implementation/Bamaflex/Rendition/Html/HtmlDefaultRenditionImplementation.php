        ...
        if ($this->has_advices())
        {
            ...
            foreach ($enrollments as $enrollment)
            {
                if ($this->has_advices($enrollment))
                {
                    ...
                    {
                        $tab_image_path = Theme :: getInstance()->getImagePath($enrollment_namespace) . 'result_type/' .
                    ...
                    $tab_image_path = Theme :: getInstance()->getImagePath($enrollment_namespace) . 'contract_type/' .
    ...
    public function get_advices_table($enrollment)
    {
        ...
        foreach ($advices as $key => $advice)
        {
            ...
            if ($advice->get_motivation())
            {
                ...
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_MOTIVATION . '.png" alt="' .
            ...
            if ($advice->get_ombudsman())
            {
                ...
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_OMBUDSMAN . '.png" alt="' .
            ...
            if ($advice->get_vote())
            {
                ...
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_VOTE . '.png" alt="' .
            ...
            if ($advice->get_measures() /*&& ($advice->get_measures_visible())*/)
            {
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_MEASURES_VALID .
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_MEASURES_INVALID .
            ...
            if ($advice->get_advice()/* && ($advice->get_advice_visible())*/)
            {
                ...
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'type/' . Advice :: TYPE_ADVICE . '.png" alt="' .
