...
class GraphRenderer
{
    ...
    public function __construct($module, $user_id, $application, $action, $statistics)
    {
        ...
        $path = Path :: getInstance()->getStoragePath() . ClassnameUtilities :: getInstance()->namespaceToPath(__NAMESPACE__) . '/graph_data/' .
    ...
    public function chart()
    {
        ...
        $image_path = Path :: getInstance()->getStoragePath() . ClassnameUtilities :: getInstance()->namespaceToPath(__NAMESPACE__) . '/chart/';
        ...
        if (! file_exists($image_path . $image_file))
        {
            ...
            $graph->loadColorPalette(Path :: getInstance()->getConfigurationPath() . 'Resources' . DIRECTORY_SEPARATOR . 'Css' . DIRECTORY_SEPARATOR . Theme :: get_theme() . '/plugin/pchart/tones.txt');
        ...
        $web_path = Path :: getInstance()->getStoragePath(true) . ClassnameUtilities :: getInstance()->namespaceToPath(__NAMESPACE__) . '/chart/' . $image_file;
    ...
    public function get_months()
    {
        ...
        {
            $path = Path :: getInstance()->getStoragePath() . ClassnameUtilities :: getInstance()->namespaceToPath(__NAMESPACE__) . '/months/' .
