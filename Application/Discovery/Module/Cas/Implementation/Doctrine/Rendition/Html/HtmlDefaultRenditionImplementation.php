...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function get_statistics_table($action)
    {
        ...
        else
        {
            ...
            {
                $path = Path :: getInstance()->getStoragePath() . ClassnameUtilities :: getInstance()->namespaceToPath(__NAMESPACE__) . '/data/' .
                ...
                $sub_tabs->add_tab(
                    new DynamicContentTab(
                        ...
                        Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'sub_tabs/1.png',
                        $graph->chart()));
                ...
                $sub_tabs->add_tab(
                    new DynamicContentTab(
                        ...
                        Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'sub_tabs/3.png',
                        $table->toHTML()));
