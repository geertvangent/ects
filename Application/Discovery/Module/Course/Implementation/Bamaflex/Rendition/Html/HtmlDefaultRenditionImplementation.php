...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function get_general()
    {
        ...
        if (! is_null($course->get_following_impossible()->get_credit()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() .
                     'general/following_impossible/credit.png" alt="' . Translation :: get('CreditPossible') .
                     '" title="' . Translation :: get('CreditPossible') . '"/>';
                LegendTable :: get_instance()->add_symbol(
                    $image,
        ...
        if (! is_null($course->get_following_impossible()->get_exam_degree()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() .
                     'general/following_impossible/exam_degree.png" alt="' . Translation :: get('ExamDegreePossible') .
        ...
        if (! is_null($course->get_following_impossible()->get_exam_credit()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() .
                     'general/following_impossible/exam_credit.png" alt="' . Translation :: get('ExamCreditPossible') .
    ...
    public function get_course_evaluations($course)
    {
        ...
        elseif ($course->get_programme_type() == Course :: PROGRAMME_TYPE_COMPLEX)
        {
            ...
            {
                $exam_parts_image = '<img src="' . Theme :: getInstance()->getImagePath() .
                     'evaluation/second_chance/exam_parts/' . $course->get_second_chance()->get_exam_parts() .
