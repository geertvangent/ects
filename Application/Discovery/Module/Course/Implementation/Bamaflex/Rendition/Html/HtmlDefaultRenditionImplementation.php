...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function render()
    {
        ...
        $tabs->add_tab(
            new DynamicContentTab(
                ...
                Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_GENERAL . '.png',
                $this->get_general()));
        if ($course->has_materials())
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_MATERIALS . '.png',
                    $this->get_materials()));
        }
        if ($course->has_activities())
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_ACTIVITIES . '.png',
                    $this->get_activities()));
        }
        if ($course->has_competences())
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_COMPETENCES . '.png',
        ...
        if ($course->has_content())
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_CONTENT . '.png',
                    $this->get_content()));
        }
        ...
        $tabs->add_tab(
            new DynamicContentTab(
                ...
                Theme :: getInstance()->getImagePath() . 'tabs/' . Module :: TAB_EVALUATIONS . '.png',
    ...
    public function get_general()
    {
        ...
        $teaching_assignment_module_instance = \Chamilo\Application\Discovery\Module :: exists(
        ...
        if ($course->get_programme_type() != Course :: PROGRAMME_TYPE_COMPLEX)
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'general/timeframe/' .
                ...
                foreach ($course->get_teachers() as $coordinator)
                {
                    ...
                    if ($coordinator->is_coordinator())
                    {
                        ...
                        if ($user)
                        {
                            ...
                            $is_allowed = \Chamilo\Application\Discovery\Module\TeachingAssignment\Implementation\Bamaflex\Rights :: is_allowed(
                                \Chamilo\Application\Discovery\Module\TeachingAssignment\Implementation\Bamaflex\Rights :: VIEW_RIGHT,
        ...
        $images = array();
        $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'general/following_impossible/degree.png" alt="' .
        ...
        if (! is_null($course->get_following_impossible()->get_credit()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'general/following_impossible/credit.png" alt="' .
        ...
        if (! is_null($course->get_following_impossible()->get_exam_degree()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'general/following_impossible/exam_degree.png" alt="' .
        ...
        if (! is_null($course->get_following_impossible()->get_exam_credit()))
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'general/following_impossible/exam_credit.png" alt="' .
        ...
        if ($course_result_module_instance)
        {
            ...
            if ($is_allowed)
            {
                ...
                $properties[Translation :: get(
                    'TypeName',
                    null,
                    'application\discovery\module\course_results\implementation\bamaflex')] = Theme :: getInstance()->getImage(
                    'logo/16',
                    'png',
                    Translation :: get(
                        'TypeName',
    ...
    public function get_course_materials_by_type($course, $type)
    {
        ...
        foreach ($course->get_materials_by_type($type) as $material)
        {
            ...
            else
            {
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'material/for_sale.png" alt="' .
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'material/not_for_sale.png" alt="' .
        ...
        if (count($course->get_competences_by_type(Competence :: TYPE_BEGIN)) > 0)
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'competence/tabs/' . Competence :: TYPE_BEGIN . '.png',
        ...
        if (count($course->get_competences_by_type(Competence :: TYPE_END)) > 0)
        {
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'competence/tabs/' . Competence :: TYPE_END . '.png',
    ...
    public function get_course_contents($course)
    {
        ...
        if (! StringUtilities :: is_null_or_empty($course->get_goals(), true))
        {
            $html[] = '<div class="content_object" style="background-image: url(' .
                 Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'content/goals.png);">';
        ...
        {
            $html[] = '<div class="content_object" style="background-image: url(' .
                 Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'content/contents.png);">';
            $html[] = '<div class="title">';
        ...
        {
            $html[] = '<div class="content_object" style="background-image: url(' .
                 Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'content/coaching.png);">';
            $html[] = '<div class="title">';
        ...
        {
            $html[] = '<div class="content_object" style="background-image: url(' .
                 Theme :: getInstance()->getImagePath(__NAMESPACE__) . 'content/succession.png);">';
            $html[] = '<div class="title">';
    ...
    public function get_course_evaluations($course)
    {
             ...
             $course->get_programme_type() == Course :: PROGRAMME_TYPE_PART)
        {
            ...
            {
                $exam_image = '<img src="' . Theme :: getInstance()->getImagePath() .
            ...
            if (! is_null($course->get_second_chance()->get_enrollment()))
            {
                ...
                {
                    $enrollment_image = '<img src="' . Theme :: getInstance()->getImagePath() .
        ...
        elseif ($course->get_programme_type() == Course :: PROGRAMME_TYPE_COMPLEX)
        {
            ...
            {
                $exam_parts_image = '<img src="' . Theme :: getInstance()->getImagePath() . 'evaluation/second_chance/exam_parts/' .
        ...
        foreach ($course->get_evaluations() as $evaluation)
        {
            ...
            else
            {
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'evaluation/permanent.png" alt="' .
                ...
                {
                    $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'evaluation/not_permanent.png" alt="' .
