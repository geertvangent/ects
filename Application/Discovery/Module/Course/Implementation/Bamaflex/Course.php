...
class Course extends DiscoveryItem
{
    ...
    public function has_content($include_children = true)
    {
        ...
        if (! StringUtilities :: getInstance()->isNullOrEmpty($this->get_goals(), true))
        {
            return true;
        }

        if (! StringUtilities :: getInstance()->isNullOrEmpty($this->get_contents(), true))
        {
            return true;
        }

        if (! StringUtilities :: getInstance()->isNullOrEmpty($this->get_coaching(), true))
        {
            return true;
        }

        if (! StringUtilities :: getInstance()->isNullOrEmpty($this->get_succession(), true))
        {
            return true;
        }
