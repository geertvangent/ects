...
use Chamilo\Application\Discovery\Module\Training\Implementation\Bamaflex\Rendition\RenditionImplementation;
...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    {
        return \Chamilo\Application\Discovery\Module\Training\Rendition\Rendition :: launch($this);
    }
    ...
    public function get_trainings_table($year)
    {
        ...
        foreach ($trainings as $key => $training)
        {
            ...
            $bama_type_image = '<img src="' . Theme :: getInstance()->getImagePath() . 'bama_type/' . $training->get_bama_type() .
                ...
                if ($group_module_instance)
                {
                    ...
                    if ($is_allowed)
                    {
                        ...
                        $toolbar_item = new ToolbarItem(
                            ...
                            Theme :: getInstance()->getImagePath('application\discovery\module\group\implementation\bamaflex') .
                                 'logo/16.png',
                                $url,
