<?php
namespace Ehb\Application\Discovery\Module\FacultyInfo\Implementation\Bamaflex\DataManager;
            ...
            if (! isset($this->faculties[$faculty_id][$source]))
            {
                ...
                if ($statement instanceof PDOStatement)
                {
                    ...
                    $conditions[] = new EqualityCondition(
                        ...
                        new StaticConditionVariable(Utilities :: get_namespace_from_object($faculty)));
                    $condition = new AndCondition($conditions);
