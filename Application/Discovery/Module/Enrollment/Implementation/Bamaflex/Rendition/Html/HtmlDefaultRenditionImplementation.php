...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function get_enrollments_table($contract_type = Enrollment :: CONTRACT_TYPE_ALL)
    {
        ...
        foreach ($enrollments as $key => $enrollment)
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'result_type/' . $enrollment->get_result() .
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'generation_student/' .
            ...
            // $details_action = new ToolbarItem(Translation :: get('ShowCourses'), Theme :: getInstance()->getCommonImagePath() .
        ...
        if (count($this->get_enrollments()) > 0)
        {
            ...
            $tabs->add_tab(
                new DynamicContentTab(
                    ...
                    Theme :: getInstance()->getImagePath() . 'contract_type/0.png',
            ...
            foreach ($contract_types as $contract_type)
            {
                $tabs->add_tab(
                    new DynamicContentTab(
                        ...
                        Theme :: getInstance()->getImagePath() . 'contract_type/' . $contract_type . '.png',
