...
use Chamilo\Application\Discovery\Module\Employment\Implementation\Bamaflex\Rendition\RenditionImplementation;
use Chamilo\Application\Discovery\Module\Employment\Implementation\Bamaflex\Rights;
...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function get_table()
    {
        ...
        foreach ($this->get_employments() as $employment)
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'fund/' . $employment->get_fund_id() .
                     '.png" alt="' . Translation :: get($employment->get_fund_string()) . '" title="' .
            ...
            $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'active/' . $employment->get_active() .
                 '.png" alt="' . Translation :: get($employment->get_active_string()) . '" title="' .
