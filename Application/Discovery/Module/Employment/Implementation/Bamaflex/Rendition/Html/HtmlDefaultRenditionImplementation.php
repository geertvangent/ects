...
class HtmlDefaultRenditionImplementation extends RenditionImplementation
{
    ...
    public function get_table()
    {
        ...
        foreach ($this->get_employments() as $employment)
        {
            ...
            {
                $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'fund/' . $employment->get_fund_id() . '.png" alt="' .
            ...
            $image = '<img src="' . Theme :: getInstance()->getImagePath() . 'active/' . $employment->get_active() . '.png" alt="' .
