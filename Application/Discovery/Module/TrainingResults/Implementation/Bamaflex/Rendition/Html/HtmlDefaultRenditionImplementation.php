    ...
    public function get_table_data()
    {
        ...
        foreach ($this->get_training_results() as $enrollment)
        {
            ...
            if ($enrollment->is_special_result())
            {
                $image = '<img src="' .
                     Theme :: getInstance()->getImagePath(
                        'application\discovery\module\enrollment\implementation\bamaflex') . 'result_type/' .
            ...
            if ($enrollment->has_distinction())
            {
                $image = '<img src="' .
                     Theme :: getInstance()->getImagePath(
                        'application\discovery\module\enrollment\implementation\bamaflex') . 'distinction_type/' .
