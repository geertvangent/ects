...
class Autoloader
{
    ...
    private static $map = array('Autoloader' => '/autoloader.class.php', 
            ...
            'DiscoveryAjaxUsersFeed' => '/ajax/users_feed.class.php', 'DataConnector' => '/lib/data_connector.class.php', 
            'DataSource' => '/lib/data_source.class.php', 'DataSourceInstance' => '/lib/data_source_instance.class.php', 
            ...
            'DiscoveryItem' => '/lib/discovery_item.class.php', 'LegendTable' => '/lib/legend_table.class.php', 
            'Module' => '/lib/module.class.php', 'ModuleInstance' => '/lib/module_instance.class.php', 
            'ModuleInstanceSetting' => '/lib/module_instance_setting.class.php', 
            'Parameters' => '/lib/parameters.class.php', 'PlatformGroupEntity' => '/lib/platform_group_entity.class.php', 
            'RightsGroupEntityRight' => '/lib/rights_group_entity_right.class.php', 
            'SortableTable' => '/lib/sortable_table.class.php', 'UserEntity' => '/lib/user_entity.class.php', 
