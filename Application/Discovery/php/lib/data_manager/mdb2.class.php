...
class Mdb2DiscoveryDataManager extends Mdb2Database implements DiscoveryDataManagerInterface
{
    ...
    function delete_rights_group_entity_rights($right_id)
    {
    ...
    function retrieve_rights_group_entity_rights($condition = null, $order_by = array(), $offset = 0, $max_objects = -1)
    {
        return $this->retrieve_objects(RightsGroupEntityRight :: get_table_name(), $condition, $offset, $max_objects, $order_by, RightsGroupEntityRight :: CLASS_NAME);
    }
