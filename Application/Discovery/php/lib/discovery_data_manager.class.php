...
class DataManager extends \common\libraries\DataManager
{
    ...
    // *
    // * @return DataManagerInterface The data manager.
    // */
    ...
    // $class = __NAMESPACE__ . '\\' . Utilities :: underscores_to_camelcase($type) . 'DataManager';
    ...
    public static function create_module_rights_storage_units($module)
    {
        ...
        if (! $rights :: get_instance()->create_subtree_root_location(
            Manager :: APPLICATION_NAME . '_' . $module->get_id(), 
            0, 
