 ...
 */
require_once dirname(__FILE__) . '/module_instance_browser_table_data_provider.class.php';
require_once dirname(__FILE__) . '/module_instance_browser_table_column_model.class.php';
require_once dirname(__FILE__) . '/module_instance_browser_table_cell_renderer.class.php';
/**
