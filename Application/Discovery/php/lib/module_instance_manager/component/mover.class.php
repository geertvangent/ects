    ...
    function run()
    {
        ...
        if (isset($id))
        {
            ...
            if ($new_place > 0 && $new_place <= $max)
            {
                ...
                $conditions[] = new EqualityCondition(ModuleInstance :: PROPERTY_CONTENT_TYPE, 
            ...
            $this->redirect(
                    Translation :: get($succes ? 'ObjectUpdated' : 'ObjectNotUpdated', 
                    ...
                    array(
                            ...
                            ModuleInstanceManager :: PARAM_CONTENT_TYPE => $module_instance->get_content_type()));
        }
        else
        {
            $this->display_error_page(
                    htmlentities(
                            Translation :: get('NoObjectsSelected', 
