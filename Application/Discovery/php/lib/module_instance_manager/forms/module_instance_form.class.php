...
class ModuleInstanceForm extends FormValidator
{
    ...
    public function build_general_form()
    {
        ...
        $this->add_html_editor(
            ModuleInstance :: PROPERTY_DESCRIPTION, 
            Translation :: get('Description', null, $this->module_instance->get_type()), 
            true);
        $this->addElement(
            'checkbox', 
    ...
    public function setDefaults($defaults = array ())
    {
        ...
        {
            $defaults[ModuleInstance :: PROPERTY_TITLE] = Translation :: get(
                'TypeName', 
                null, 
                $this->module_instance->get_type());
        }
        ...
        {
            $defaults[ModuleInstance :: PROPERTY_DESCRIPTION] = Translation :: get(
                'TypeDescription', 
                null, 
                $this->module_instance->get_type());
        }
