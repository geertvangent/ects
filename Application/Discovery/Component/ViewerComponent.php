...
class ViewerComponent extends Manager implements DelegateComponent
{
    ...
    public function run()
    {
        ...
        if (! $module_id)
        {
            ...
            $current_module_instance = \Ehb\Application\Discovery\Instance\DataManager :: retrieve(
                Instance :: class_name(), 
        ...
        {
            $current_module_instance = \Ehb\Application\Discovery\Instance\DataManager :: retrieve_by_id(
                Instance :: class_name(), 
                (int) $module_id);
