...
class Autoloader
{
     ...
     */
    private static $map = array('Autoloader' => '/autoloader.class.php', 'Connection' => '/lib/connection.class.php', 
            'DataSource' => '/lib/data_source.class.php', 
            'DiscoveryDataManager' => '/lib/discovery_data_manager.class.php', 'History' => '/lib/history.class.php', 
