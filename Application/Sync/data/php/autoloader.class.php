...
class Autoloader
{
     ...
     */
     private static $map = array(
         ...
         'PortfolioIntroductionComponent' => '/lib/manager/component/portfolio_introduction.class.php',
         'PortfolioLocationComponent' => '/lib/manager/component/portfolio_location.class.php',
