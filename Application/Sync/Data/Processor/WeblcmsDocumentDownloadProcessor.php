...
use Chamilo\Application\EhbSync\Data\Storage\DataClass\WeblcmsDocumentDownload;
 ...
 */
class WeblcmsDocumentDownloadProcessor
{
    ...
    {
        $this->logger = new FileLogger(__DIR__ . '/weblcms_document_download.log');
    }
    ...
    protected function handle_visit_tracker($visit_tracker)
    {
         ...
         * visited
         */
        if (is_array($publication_id) || is_array($category_id))
        {
            return false;
        }
        ...
        $visit = new WeblcmsDocumentDownload();
