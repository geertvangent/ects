...
use Ehb\Application\Sync\Data\Storage\DataClass\WeblcmsVisit;
...
class WeblcmsVisitProcessor
{
    ...
    {
        $this->logger = new FileLogger(__DIR__ . '/weblcms_visit.log');
    }
    ...
    protected function process_visit_tracker()
    {
        ...
        $pattern = '%application=weblcms%go=course_viewer%';
        $offset = 0;
        $count = 100000;
