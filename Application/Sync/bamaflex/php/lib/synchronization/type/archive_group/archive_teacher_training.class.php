...
class ArchiveTeacherTrainingGroupSynchronization extends ArchiveTrainingGroupSynchronization
{
    ...
    function get_user_official_codes()
    {
        ...
        $query = 'SELECT DISTINCT person_id FROM [dbo].[v_discovery_list_user_teacher_basic]  WHERE training_id = "' . $this->get_parameter(
                self :: RESULT_PROPERTY_TRAINING_ID) . '" AND type = 2';
