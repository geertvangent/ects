...
class UserTypeGuestTeacherGroupSynchronization extends GroupSynchronization
{
    ...
    function get_user_official_codes()
    {
        ...
        $query = 'SELECT DISTINCT person_id FROM [dbo].[v_discovery_list_user_guest_teacher]  WHERE faculty_id  = ' . $this->get_department()->get_parameter(DepartmentGroupSynchronization :: RESULT_PROPERTY_DEPARTMENT_ID) . '
