...
class StudentTrainingTrajectoriesTemplateSubGroupSynchronization extends GroupSynchronization
{
    ...
    public function get_user_official_codes()
    {
        ...
        $query = 'SELECT DISTINCT person_id FROM [dbo].[v_discovery_list_user_student_basic]  WHERE trajectory_type = 1 AND type = 1 AND result != 8 AND trajectory_id = "' . $this->get_parameter(self :: RESULT_PROPERTY_TRAJECTORY_ID) . '"';
