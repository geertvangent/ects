...
class StudentTrainingChoicesOptionGroupSynchronization extends GroupSynchronization
{
    ...
    function get_user_official_codes()
    {
        ...
        $query = 'SELECT DISTINCT person_id FROM [dbo].[v_discovery_list_user]  WHERE choice_id = "' . $this->get_parameter(self :: RESULT_PROPERTY_CHOICE_OPTION_ID) . '" AND type = 1 AND result != 8';
