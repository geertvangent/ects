...
class StatisticsComponent extends Manager implements DelegateComponent
{
    ...
    private $action_map = array('AUTHENTICATION_SUCCESS' => 1, 'TICKET_GRANTING_TICKET_CREATED' => 2,
            'TICKET_GRANTING_TICKET_DESTROYED' => 3, 'SERVICE_TICKET_CREATED' => 4, 'SERVICE_TICKET_VALIDATED' => 5,
            'AUTHENTICATION_FAILED' => 6, 'TICKET_GRANTING_TICKET_NOT_CREATED' => 7, 'SERVICE_TICKET_NOT_CREATED' => 8,
    ...
    public function run()
    {
        try
        {
            ...
            $audit_trails = \application\ehb_sync\cas\storage\DataManager :: retrieves(ComAuditTrail :: class_name(),
                    $parameters);
    ...
    public function convert(ComAuditTrail $audit_trail)
    {
        ...
        if (in_array($statistic->get_action_id(),
                array(Statistic :: ACTION_AUTHENTICATION_SUCCESS, Statistic :: ACTION_TICKET_GRANTING_TICKET_CREATED,
                        ...
                        Statistic :: ACTION_TICKET_GRANTING_TICKET_NOT_CREATED)))
        {
            ...
            $user = \user\DataManager :: retrieve(\user\User :: class_name(),
        ...
        elseif (in_array($statistic->get_action_id(),
