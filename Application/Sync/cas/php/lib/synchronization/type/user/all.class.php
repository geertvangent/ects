    ...
    function process_data($person)
    {
        ...
        if ($user_copy instanceof User)
        {
            if ($user != $user_copy)
            {
                if ($user->update())
                {
                    echo 'Updated:  [' . $person->get_person_id() . ']' . $person->get_first_name() . ' ' . $person->get_last_name() . "\n";
        ...
        else
        {
            ...
            if ($user->create())
            {
                echo 'Added: [' . $person->get_person_id() . ']' . $person->get_first_name() . ' ' . $person->get_last_name() . "\n";
