    ...
    private function __construct($connection = null)
    {
        ...
        if (is_null($connection))
        {
            $cas_dbms = Configuration::getInstance()->get_setting(
                array(\Ehb\Application\Sync\Cas\Data\Manager::context(), 'dbms'));
            $cas_user = Configuration::getInstance()->get_setting(
                array(\Ehb\Application\Sync\Cas\Data\Manager::context(), 'user'));
            $cas_password = Configuration::getInstance()->get_setting(
                array(\Ehb\Application\Sync\Cas\Data\Manager::context(), 'password'));
            $cas_host = Configuration::getInstance()->get_setting(
                array(\Ehb\Application\Sync\Cas\Data\Manager::context(), 'host'));
            $cas_database = Configuration::getInstance()->get_setting(
                array(\Ehb\Application\Sync\Cas\Data\Manager::context(), 'database'));
